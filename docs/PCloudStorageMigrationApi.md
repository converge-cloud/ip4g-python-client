...
[**pcloud_cloudinstances_storagemigration_pathdata_post**](PCloudStorageMigrationApi.md#pcloud_cloudinstances_storagemigration_pathdata_post) | **POST** /pcloud/v1/cloud-instances/{cloud_instance_id}/storage-migration/{migration_id}/pvm-instances/{pvm_id}/path-data | Ingest host-side path telemetry from a PVM instance.
...
# **pcloud_cloudinstances_storagemigration_pathdata_post**
> pcloud_cloudinstances_storagemigration_pathdata_post(cloud_instance_id, migration_id, pvm_id, body=body)

Ingest host-side path telemetry from a PVM instance.
...
cloud_instance_id = 'cloud_instance_id_example' # str | Cloud Instance ID of a PCloud Instance
migration_id = 'migration_id_example' # str | 
pvm_id = 'pvm_id_example' # str | 
body = NULL # object |  (optional)

try:
    # Ingest host-side path telemetry from a PVM instance.
    api_instance.pcloud_cloudinstances_storagemigration_pathdata_post(cloud_instance_id, migration_id, pvm_id, body=body)
except ApiException as e:
    print("Exception when calling PCloudStorageMigrationApi->pcloud_cloudinstances_storagemigration_pathdata_post: %s\n" % e)
```
