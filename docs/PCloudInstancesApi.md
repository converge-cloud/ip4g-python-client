...
[**pcloud_cloudinstances_regions_list**](PCloudInstancesApi.md#pcloud_cloudinstances_regions_list) | **GET** /pcloud/v1/cloud-instances/{cloud_instance_id}/regions | List a Cloud&#39;s Available Regions
...
# **pcloud_cloudinstances_regions_list**
> list[CloudRegion] pcloud_cloudinstances_regions_list(cloud_instance_id)

List a Cloud's Available Regions
...
try:
    # List a Cloud's Available Regions
    api_response = api_instance.pcloud_cloudinstances_regions_list(cloud_instance_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PCloudInstancesApi->pcloud_cloudinstances_regions_list: %s\n" % e)
```
...
[**list[CloudRegion]**](CloudRegion.md)
