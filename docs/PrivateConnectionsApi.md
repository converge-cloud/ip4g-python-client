...
------------- | ------------- | -------------
[**pcloud_private_connections_create**](PrivateConnectionsApi.md#pcloud_private_connections_create) | **POST** /pcloud/v2/cloud-instances/{cloud_instance_id}/private-connections | Create new Private Connection
...
# **pcloud_private_connections_create**
> PrivateConnection pcloud_private_connections_create(cloud_instance_id, body)
...
body = ip4g.PrivateConnectionCreate() # PrivateConnectionCreate | Parameters to create a private connection

try:
    # Create new Private Connection
    api_response = api_instance.pcloud_private_connections_create(cloud_instance_id, body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PrivateConnectionsApi->pcloud_private_connections_create: %s\n" % e)
```
 ...
 **body** | [**PrivateConnectionCreate**](PrivateConnectionCreate.md)| Parameters to create a private connection | 
