...
*AuthenticationApi* | [**service_broker_auth_refresh_token**](docs/AuthenticationApi.md#service_broker_auth_refresh_token) | **GET** /auth/v1/refresh-token | Get a refresh token from a valid access token
...
*PCloudInstancesApi* | [**pcloud_cloudinstances_regions_list**](docs/PCloudInstancesApi.md#pcloud_cloudinstances_regions_list) | **GET** /pcloud/v1/cloud-instances/{cloud_instance_id}/regions | List a Cloud&#39;s Available Regions
...
*PCloudStorageMigrationApi* | [**pcloud_cloudinstances_storagemigration_pathdata_post**](docs/PCloudStorageMigrationApi.md#pcloud_cloudinstances_storagemigration_pathdata_post) | **POST** /pcloud/v1/cloud-instances/{cloud_instance_id}/storage-migration/{migration_id}/pvm-instances/{pvm_id}/path-data | Ingest host-side path telemetry from a PVM instance.
...
*PrivateConnectionsApi* | [**pcloud_private_connections_create**](docs/PrivateConnectionsApi.md#pcloud_private_connections_create) | **POST** /pcloud/v2/cloud-instances/{cloud_instance_id}/private-connections | Create new Private Connection
...
*DefaultApi* | [**pcloud_cloudinstances_storagetypes_get**](docs/DefaultApi.md#pcloud_cloudinstances_storagetypes_get) | **GET** /pcloud/v1/cloud-instances/{cloud_instance_id}/storage-types | Get the list of storage types available for the given cloud instance&#39;s associated plan. 
...
## Documentation For Models
 ...
 - [PrivateConnectionCreate](docs/PrivateConnectionCreate.md)
 ...
 - [StorageMigrationHistoryEntry](docs/StorageMigrationHistoryEntry.md)
 ...
 - [StorageMigrationVolumeDetail](docs/StorageMigrationVolumeDetail.md)
