...
class OwnerInfo(object):
    ...
    def __init__(self, country_code=None, currency_code=None, email=None, iam_id=None, is_ib_mer=None, name=None, softlayer_ids=None, softlayer_subscriptions=None, user_id=None, _configuration=None):  # noqa: E501
