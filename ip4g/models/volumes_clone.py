...
class VolumesClone(object):
    ...
    def __init__(self, action=None, creation_date=None, failure_message=None, last_update_date=None, name=None, percent_complete=None, status=None, volumes_clone_id=None, _configuration=None):  # noqa: E501
