...
class Tenant(object):
    ...
    def __init__(self, cloud_instances=None, creation_date=None, enabled=None, icn=None, peering_networks=None, ssh_keys=None, tenant_id=None, _configuration=None):  # noqa: E501
