...
class UserAccess(object):
    ...
    def __init__(self, id=None, rev=None, base_role='user-readonly', can_create_sa=False, cloud_instances=None, is_type_sa=False, member_of=None, notes=None, sa_metadata=None, _configuration=None):  # noqa: E501
