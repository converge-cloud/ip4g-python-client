...
class PVMInstanceReference(object):
    ...
    def __init__(self, addresses=None, console_language=None, creation_date=None, disk_size=None, fault=None, health=None, host_id=None, href=None, image_id=None, license_repository_capacity=None, maxmem=None, maxproc=None, memory=None, minmem=None, minproc=None, networks=None, operating_system=None, os_type=None, pin_policy=None, placement_group='none', proc_type='dedicated', processors=None, progress=None, pvm_instance_id=None, sap_profile=None, server_name=None, software_licenses=None, srcs=None, status=None, storage_pool=None, storage_pool_affinity=True, storage_type=None, sys_type=None, task_state=None, updated_date=None, virtual_cores=None, _configuration=None):  # noqa: E501
    ...
    @property
    def task_state(self):
        """Gets the task_state of this PVMInstanceReference.  # noqa: E501

        Intermediate task status  # noqa: E501

        :return: The task_state of this PVMInstanceReference.  # noqa: E501
        :rtype: str
        """
    ...
    def task_state(self, task_state):
        """Sets the task_state of this PVMInstanceReference.

        Intermediate task status  # noqa: E501

        :param task_state: The task_state of this PVMInstanceReference.  # noqa: E501
        :type: str
        """
