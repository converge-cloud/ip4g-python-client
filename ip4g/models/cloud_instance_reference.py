...
class CloudInstanceReference(object):
    ...
    def __init__(self, capabilities=None, cloud_instance_id=None, enabled=None, href=None, initialized=None, limits=None, name=None, region=None, _configuration=None):  # noqa: E501
