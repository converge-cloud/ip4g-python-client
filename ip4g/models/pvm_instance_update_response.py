...
class PVMInstanceUpdateResponse(object):
    ...
    def __init__(self, license_repository_capacity=None, memory=None, pin_policy=None, proc_type=None, processors=None, server_name=None, status_url=None, _configuration=None):  # noqa: E501
