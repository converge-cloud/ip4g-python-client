...
class PVMInstanceAction(object):
    ...
    def action(self):
        ...
        Name of the action to take; can be start, stop, hard-reboot, soft-reboot, immediate-shutdown, reset-state, dump-restart  # noqa: E501
    ...
    def action(self, action):
        ...
        allowed_values = ["start", "stop", "immediate-shutdown", "hard-reboot", "soft-reboot", "reset-state", "dump-restart"]  # noqa: E501
