...
class CloudInstance(object):
    ...
    def __init__(self, capabilities=None, cloud_instance_id=None, enabled=None, initialized=None, limits=None, name=None, openstack_id=None, pvm_instances=None, region=None, tenant_id=None, usage=None, _configuration=None):  # noqa: E501
