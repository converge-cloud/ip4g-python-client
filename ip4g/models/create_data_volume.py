...
class CreateDataVolume(object):
    ...
    def __init__(self, affinity_pvm_instance=None, anti_affinity_pvm_instances=None, anti_affinity_volumes=None, disk_type=None, replication_enabled=None, size=None, volume_pool=None, affinity_policy=None, affinity_volume=None, name=None, shareable=None, _configuration=None):  # noqa: E501
