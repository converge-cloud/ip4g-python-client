...
class CloudInstanceUsageLimits(object):
    ...
    def __init__(self, instance_memory=None, instance_proc_units=None, instances=None, memory=None, peering_bandwidth=None, peering_networks=None, proc_units=None, processors=None, storage=None, storage_ssd=None, storage_standard=None, storage_tiers=None, _configuration=None):  # noqa: E501
    ...
    @property
    def storage_tiers(self):
        """Gets the storage_tiers of this CloudInstanceUsageLimits.  # noqa: E501

        The storage types and their respective amounts in TB.  # noqa: E501

        :return: The storage_tiers of this CloudInstanceUsageLimits.  # noqa: E501
        :rtype: list[StorageTier]
        """
        return self._storage_tiers

    @storage_tiers.setter
    def storage_tiers(self, storage_tiers):
        """Sets the storage_tiers of this CloudInstanceUsageLimits.

        The storage types and their respective amounts in TB.  # noqa: E501

        :param storage_tiers: The storage_tiers of this CloudInstanceUsageLimits.  # noqa: E501
        :type: list[StorageTier]
        """

        self._storage_tiers = storage_tiers
