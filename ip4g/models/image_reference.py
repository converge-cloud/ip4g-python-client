...
class ImageReference(object):
    ...
    def __init__(self, creation_date=None, description=None, href=None, image_id=None, last_update_date=None, name=None, specifications=None, state=None, storage_pool=None, storage_type=None, _configuration=None):  # noqa: E501
