...
class PVMInstanceClone(object):
    ...
    def __init__(self, key_pair_name=None, memory=None, name=None, networks=None, proc_type='dedicated', processors=None, software_licenses=None, volume_ids=None, _configuration=None):  # noqa: E501
