...
class MultiVolumesCreate(object):
    ...
    def __init__(self, affinity_pvm_instance=None, affinity_policy=None, affinity_volume=None, anti_affinity_pvm_instances=None, anti_affinity_volumes=None, count=None, disk_type=None, name=None, replication_enabled=None, shareable=None, size=None, volume_pool=None, _configuration=None):  # noqa: E501
