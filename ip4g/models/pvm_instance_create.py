...
class PVMInstanceCreate(object):
    ...
    def __init__(self, image_id=None, key_pair_name=None, license_repository_capacity=None, memory=None, migratable=True, network_ids=None, networks=None, pin_policy=None, placement_group=None, proc_type='dedicated', processors=None, replicant_affinity_policy='none', replicant_naming_scheme='suffix', replicants=None, server_name=None, software_licenses=None, spp_name_or_id=None, storage_affinity=None, storage_connection=None, storage_pool=None, storage_type=None, sys_type=None, user_data=None, virtual_cores=None, volume_ids=None, _configuration=None):  # noqa: E501
        ...
        if spp_name_or_id is not None:
            self.spp_name_or_id = spp_name_or_id
    ...
    @property
    def spp_name_or_id(self):
        """Gets the spp_name_or_id of this PVMInstanceCreate.  # noqa: E501

        Assign this newly created compute instance to the given Shared Processor Pool [SPP] (as identified by either name or ID).  You may not assign the new instance to an SPP and also assign it to a PlacementGroup and/or with an affinityPolicy.   # noqa: E501

        :return: The spp_name_or_id of this PVMInstanceCreate.  # noqa: E501
        :rtype: str
        """
        return self._spp_name_or_id

    @spp_name_or_id.setter
    def spp_name_or_id(self, spp_name_or_id):
        """Sets the spp_name_or_id of this PVMInstanceCreate.

        Assign this newly created compute instance to the given Shared Processor Pool [SPP] (as identified by either name or ID).  You may not assign the new instance to an SPP and also assign it to a PlacementGroup and/or with an affinityPolicy.   # noqa: E501

        :param spp_name_or_id: The spp_name_or_id of this PVMInstanceCreate.  # noqa: E501
        :type: str
        """

        self._spp_name_or_id = spp_name_or_id
